...
<div class="productList_base">
	<article style="margin-left:120px;">
		<img src="images/Shipping.PNG" style="position: relative; float:left; margin-right:10px; margin-top:3px;">
      <h2 style="text-align: left; font-style: monospace; text-decoration:underline dashed;">Delivery List</h2>
