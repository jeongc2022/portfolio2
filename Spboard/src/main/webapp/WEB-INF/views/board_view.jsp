...
<div id="wrap" align="center">
	<h1>게시글 상세보기</h1>
	<table>
		<tr><th>작성자</th><td>${board.name}</td><th>이메일</th><td>${board.email}</td></tr>
	...
	onclick="open_win('board_edit_form?num=${board.num}', 'update')">
	<input type="button" value="게시글 삭제" 
	onclick="open_win('board_delete_form?num=${board.num}', 'delete')">
</div>
</body>
</html>