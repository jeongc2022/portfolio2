...
<div class="productList_base">
   <article id="product_detail">
      <h2
         style="text-align: left; font-style: monospace; text-decoration: underline dashed;">Update
         Product</h2>
      ...
      <form name="frmm" method="post">
         ...
         <table id="list" style="font-style: monospace;">
            ...
            <tr>
               ...
               <th>상품 색깔</th>
               <td><input type="text" class="admin_inputdata" id="color" name="color" value="${Ulist.color}"></td>
               <th>상품 수량</th>
               <td colspan="3"><input type="text" class="admin_inputdata"
                  id="qty"  name="qty" value="${Ulist.qty}"></td>
            </tr>
            <tr>
               <th align="center">상품명</th>
               <td colspan="5"><input type="text" class="admin_inputdata"
                  id="pname"  name="pname"  value="${Ulist.pname}"></td>
            </tr>
            <tr>
               <th>원가[A]</th>
               <td width="100"><input type="text" class="admin_inputdata"
                  id="oriprice"  name="oriprice" value="${Ulist.oriprice}"></td>

               <th>판매가[B]</th>
               <td width="100"><input type="text" class="admin_inputdata"
                  id="price"  name="price" value="${Ulist.price}"> </td>

               <th>마진[B-A]</th>
               <td width="100"><input type="text" class="admin_inputdata"
                  id="margin"  name="margin" value="${Ulist.margin}"></td>
            ...
            <tr>
               ...
               <td colspan="5" style="text-align: left;"><textarea rows="10"
                     cols="70" id="contents"  name="content">${Ulist.content}</textarea></td>
            </tr>
         </table>
